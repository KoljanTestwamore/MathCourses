...
var app = (function () {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(footer, "class", "footer svelte-1deatvv");
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "logo svelte-19m44a");
    			add_location(div0, file$3, 5, 4, 119);
    			attr_dev(a0, "href", "/");
    			attr_dev(a0, "class", "svelte-19m44a");
    			add_location(a0, file$3, 10, 8, 278);
    			attr_dev(a1, "href", "/");
    			attr_dev(a1, "class", "svelte-19m44a");
    			add_location(a1, file$3, 11, 8, 343);
    			attr_dev(a2, "href", "/");
    			attr_dev(a2, "class", "svelte-19m44a");
    			add_location(a2, file$3, 12, 8, 411);
    			add_location(div1, file$3, 8, 4, 177);
    			attr_dev(nav, "class", "navigation svelte-19m44a");
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", button_class_value = "" + (null_to_empty("button " + /*className*/ ctx[1]) + " svelte-1go49ph"));
    		...
    		p: function update(new_ctx, [dirty]) {
    			...
    			if (!current || dirty & /*className*/ 2 && button_class_value !== (button_class_value = "" + (null_to_empty("button " + /*className*/ ctx[1]) + " svelte-1go49ph"))) {
    ...
    // (34:12) <Button className="button">
    function create_default_slot_1(ctx) {
    	let t;

    	const block = {
    		c: function create() {
    			t = text("Попробовать неделю бесплатно");
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, t, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(34:12) <Button className=\\\"button\\\">",
    		ctx
    	});
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = text(t3_value);
    			t4 = space();
    			if (!src_url_equal(img.src, img_src_value = /*item*/ ctx[1].image)) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "item");
    			attr_dev(img, "class", "svelte-1gajinz");
    			add_location(img, file$1, 46, 20, 1769);
    			attr_dev(span0, "class", "name svelte-1gajinz");
    			add_location(span0, file$1, 47, 20, 1824);
    			attr_dev(span1, "class", "svelte-1gajinz");
    			add_location(span1, file$1, 48, 20, 1883);
    			attr_dev(div, "class", "item svelte-1gajinz");
    			add_location(div, file$1, 45, 16, 1729);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(45:12) {#each promoItems as item}",
    		ctx
    	});
    ...
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(62:12) <Button className=\\\"button\\\">",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	let each_value = /*promoItems*/ ctx[0];
    	...
    	const block = {
    		c: function create() {
    			...
    			div1 = element("div");
    			div0 = element("div");
    			t0 = text("Математика для детей 5-7 лет\r\n                ");
    			br = element("br");
    			t1 = space();
    			span = element("span");
    			span.textContent = "на английском языке";
    			t3 = space();
    			h0 = element("h");
    			...
    			div6 = element("div");
    			div5 = element("div");
    			div5.textContent = "Записывайся!";
    			t12 = space();
    			h2 = element("h");
    			h2.textContent = "плати деньги, сука!";
    			t14 = space();
    			create_component(button1.$$.fragment);
    			add_location(br, file$1, 25, 16, 1064);
    			attr_dev(span, "class", "svelte-1gajinz");
    			add_location(span, file$1, 26, 16, 1086);
    			attr_dev(div0, "class", "title svelte-1gajinz");
    			add_location(div0, file$1, 23, 12, 981);
    			attr_dev(h0, "class", "content svelte-1gajinz");
    			add_location(h0, file$1, 30, 12, 1192);
    			if (!src_url_equal(img.src, img_src_value = "https://cdn-icons-png.flaticon.com/512/3557/3557694.png")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "");
    			attr_dev(img, "class", "svelte-1gajinz");
    			add_location(img, file$1, 36, 12, 1443);
    			attr_dev(div1, "class", "container svelte-1gajinz");
    			add_location(div1, file$1, 22, 8, 944);
    			attr_dev(div2, "class", "section1 svelte-1gajinz");
    			add_location(div2, file$1, 21, 4, 912);
    			attr_dev(h1, "class", "title svelte-1gajinz");
    			add_location(h1, file$1, 40, 8, 1583);
    			attr_dev(div3, "class", "vitrine svelte-1gajinz");
    			add_location(div3, file$1, 43, 8, 1650);
    			attr_dev(div4, "class", "section2 svelte-1gajinz");
    			add_location(div4, file$1, 39, 4, 1551);
    			attr_dev(div5, "class", "title svelte-1gajinz");
    			add_location(div5, file$1, 55, 12, 2055);
    			attr_dev(h2, "class", "content svelte-1gajinz");
    			add_location(h2, file$1, 58, 12, 2138);
    			attr_dev(div6, "class", "container svelte-1gajinz");
    			add_location(div6, file$1, 54, 8, 2018);
    			attr_dev(div7, "class", "section1 svelte-1gajinz");
    			add_location(div7, file$1, 53, 4, 1986);
    			attr_dev(div8, "class", "main-content svelte-1gajinz");
    			add_location(div8, file$1, 20, 0, 880);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*promoItems*/ 1) {
    				each_value = /*promoItems*/ ctx[0];
    				validate_each_argument(each_value);
    				let i;
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	let promoItems = [
    		{
    			image: 'https://assets3.thrillist.com/v1/image/1299823/414x310/crop;webp=auto;jpeg_quality=60;progressive.jpg',
    			name: "Олег",
    	...
    	$$self.$capture_state = () => ({ Button, promoItems });

    	$$self.$inject_state = $$props => {
    		if ('promoItems' in $$props) $$invalidate(0, promoItems = $$props.promoItems);
    	};
